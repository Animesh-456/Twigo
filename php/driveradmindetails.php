				...
				<ul class='side-menu top'>
                    ...
                    <li class='active'>
						<a href='driveradmindetails.php'>
							...
							<span class='text' style="color: #ee0000;">DRIVER DETAILS</span>
						</a>
					</li>
									...
									<div class="head">
										...
										<table>
											...
											<tbody>
												...
												<tr>
												<!-- <td><img src='../img/<?php echo $row["D_name"] ?>.jfif' style='width:150px; height:100px;'></img></td> -->
													<td>
														<p style="font-weight: bold;"><?php echo $brow["D_name"]; ?></p>
													</td>
													<td id="V_id"><?php echo $brow["D_email"] ?></td>
													
													<td><?php echo $brow["D_contact"] ?></td>
													<td><?php echo $brow["D_dob"] ?></td>
													
													<?php
                                                    
                                                        $name = $brow["D_email"];
                                                        echo "
														<form action='driveradminview.php' method='POST'>
														<td style='display: none;'><label for='B_id'>V_id</label>
														<input type='text' id='B_id' name='d' value='$name' readonly>
													</td>
														<td>
