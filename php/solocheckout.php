        ...
        <div class="container">
          <div class="payment">
            ...
            <div class="payment__info">
              ...
              <form action="solocheckoutsubmit.php" method="POST" enctype="multipart/form-data">
                <div class="payment__shipping">
                  ...
                  <div class="details__user">
                    ...
                    <input style="margin-left: 350px; display:none;" type="submit" value="Confirm Booking" class="btn action__submit" name="submitsolo" id="btnimg"></input>
