...
<body>
  ...
  <form action="customereditprofile.php" method="post">
    <div class="container">
      ...
      <input type="number" placeholder="Enter Contact" name="contact" id="contact"  pattern="[0-9]{10}" value="<?php echo $row["C_contact"]?>"required>
      ...
      <select id="city" name="city" value="<?php echo $row["C_city"]?>">
      ...
      <table style="width: 100%;">
        ...
        <tr>
          <td>
            ...
            <select id="gender" name="gender" value="<?php echo $row["C_gender"]?>">
...
if($_POST){
    ...
    $sql = "UPDATE customer
    SET C_name='$name', C_address='$address', C_email='$email', C_contact='$contact', C_city='$city', C_lisence_no='$lisence',
    C_dob='$dob', C_gender='$gender';
    WHERE C_email=$email";
