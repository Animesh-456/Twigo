...
?>
    ...
    <body>
        ...
        <form action="driverupdate3.php" method="post">
            <div class="container">
                <table>
                    <tr>
                        <td>
      ...
      margin-right: 850px;">
                            ...
                            <input type="text" placeholder="Enter Email" name="email" id="email" value="<?php echo $demail ?>" required readonly>
                            ...
                            <input class="loginbtn" type='submit' name='l' value='submit' style="font-size: 20px;"></input>

                            <a href="../html/index.html" class="backbtn" style="font-size: 20px; margin-left: 100px;">Back</a>
                        </td>
