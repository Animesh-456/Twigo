				...
				<ul class='side-menu top'>
                    ...
                    <li class='active'>
						<a href='renteradminetails.php'>
							...
							<span class='text' style="color: #ee0000;">RENTER DETAILS</span>
						</a>
					</li>
									...
									<div class="head">
										...
										<table>
											...
											<tbody>
												...
												<tr>
												<!-- <td><img src='../img/<?php echo $row["R_name"] ?>.jfif' style='width:150px; height:100px;'></img></td> -->
													<td>
														<p style="font-weight: bold;"><?php echo $brow["R_name"]; ?></p>
													</td>
													<td id="V_id"><?php echo $brow["R_email"] ?></td>
												
													<td><?php echo $brow["R_contact"] ?></td>
													<td><?php echo $brow["R_DOB"] ?></td>
